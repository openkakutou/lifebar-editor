 ...
 * contract. See `.vibe/decisions/009-i18n-integration-approach.md` for why
...
export const NAMESPACE = "lifebar-editor";
 ...
 * OpenKakutou app on that origin. See `.vibe/decisions/009`.
 */
export const STORAGE_KEY = "lifebar-editor-locale";
