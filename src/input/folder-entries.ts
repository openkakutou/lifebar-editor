...
// recursive `FileSystemDirectoryReader` walk — see backlog item 011's own
...
// does not). Ported verbatim from `lifebar-viewer-web`'s own
// `src/input/folder-entries.ts` — generic gathering logic, no domain
// specifics.
