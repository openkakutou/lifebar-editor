// The "Keyboard Shortcuts" section (backlog item 008): a collapsible panel,
...
//
// Starts expanded, unlike this app's other collapsible sections (which
// start collapsed): this is the sole place a brand-new, otherwise invisible
// capability can be discovered. See
